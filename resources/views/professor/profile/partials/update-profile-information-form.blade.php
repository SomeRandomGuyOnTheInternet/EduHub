<section>
    ...
    <form method="post" action="{{ route('professor.profile.update.picture') }}" class="mt-6 space-y-6" enctype="multipart/form-data">
        ...
        <div class="mb-4">
            <div class="mb-3">
                <img id="profilePicturePreview" src="{{ $user->profile_picture ? Storage::url($user->profile_picture) : '/images/default-profiles/placeholder.jpg' }}" alt="{{ $user->name }}" class="rounded-circle border" height="100">
            </div>
